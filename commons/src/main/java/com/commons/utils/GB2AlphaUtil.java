 ...
 * 实现描述：取中文首字母大写
 *
 * @author xyj 2014-11-7 下午3:46:39
 */
public class GB2AlphaUtil {

    // 字母Z使用了两个标签，这里有２７个值
    // i, u, v都不做声母, 跟随前面的字母
    private char[]        chartable  = { '啊', '芭', '擦', '搭', '蛾', '发', '噶', '哈', '哈', '击', '喀', '垃', '妈', '拿', '哦',
    ...
    public static void main(String[] args) {
        ...
        System.out.println(string2Alpha("今日要闻"));
        System.out.println(string2Alpha("科技日日报"));
        return;
    }
}
