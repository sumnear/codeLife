...
public class EncryptUtils {  
    ...
    public static String key = "c3VtbmVhcmlzY3JlYXRlcg==";  
//    static{
//		try {
//			byte[] my = "zwlovewxxwevolwz".getBytes("UTF-8");
//			key = new BASE64Encoder().encode(my);
...
//    	byte[] my = "sumneariscreater".getBytes("UTF-8");
//		key = new BASE64Encoder().encode(my);
//		System.out.println(key);
//        System.out.println(encrypt("id=1&ip=127.321.123.441&t=1464935684239").replaceAll("\r", "").replaceAll("\n", ""));  
//        System.out.println(decrypt("ryNuzeUM5i+A8oDobSFhD9ot4anBYr8E/c9o3Um4BLBsx2dyH5uIo+pNwJuaAhVAOJDqPX7tDFk="));
//        MailActiveVO mav =new  MailActiveVO(15,"402347012@qq.com",System.currentTimeMillis());
//        System.out.println(mav.toString());
//        String re = encrypt(mav.toString()).replaceAll("\r", "").replaceAll("\n", "");
//        System.out.println(re);  
//        System.out.println(URLEncoder.encode(re,"UTF-8"));
//        System.out.println(encrypt("userId=15mail=402347012@qq.comtime=1464935684239").replaceAll("\r", "").replaceAll("\n", ""));  
//        System.out.println(decrypt("6goVZ+16uAcEQzwtHwX/NkSpMcQEeg0GcXrMOSuOploa5W3nTb/XASjzV8n+uv/fyArwxwoH8u4O5yJHOhUu1MU08/jmMOGh"));
    }  
}  