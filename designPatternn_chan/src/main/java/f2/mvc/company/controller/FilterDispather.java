package f2.mvc.company.controller;

import f2.mvc.cbf4life.view.ViewManager;
import f2.mvc.company.action.ActionDispather;
import f2.mvc.company.action.IActionDispather;
import f2.mvc.company.helper.ValueStackHelper;
import f2.mvc.company.valuestack.ValueStack;
...
public class FilterDispather implements Filter {
	...
	public void init(FilterConfig arg0) throws ServletException {
		/*
		 * 1、检查XML配置文件是否正确 2、启动监控程序，观察配置文件是否正确
		 */
	}
